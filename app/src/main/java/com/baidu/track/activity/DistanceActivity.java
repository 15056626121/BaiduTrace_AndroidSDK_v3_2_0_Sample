...
public class DistanceActivity extends BaseActivity implements
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setTitle(R.string.mileage_compensation_title);
    ...
    private void initView() {
        ...
        trackAnalysisInfoLayout = new TrackAnalysisInfoLayout(DistanceActivity.this, mMapUtil.baiduMap);
        ...
        mTrackListener = new OnTrackListener() {
            ...
            public void onHistoryTrackCallback(HistoryTrackResponse response) {
                ...
                if (StatusCodes.SUCCESS != response.getStatus()) {
                    Toast.makeText(DistanceActivity.this, response.getMessage(), Toast.LENGTH_SHORT).show();
                } else if (0 == total) {
                    Toast.makeText(DistanceActivity.this,
